<template>
  ...
  <div
    class="px-4 py-3 flex flex-col md:flex-row flex-col-reverse items-center justify-between sm:px-6"
  >
    <div class="sm:flex-1 sm:flex sm:items-center sm:justify-end pt-2 md:pt-0">
      ...
      >
        <button
          ...
          "
          :disabled="page === 1"
          class="relative inline-flex items-center px-2 py-2 rounded-l-md bg-white text-sm font-medium"
        ...
        <button
          ...
          "
          :disabled="page === pages"
          class="relative inline-flex items-center px-2 py-2 rounded-r-md bg-white text-sm font-medium text-gray"
          @click="$emit('paginate', page + 1)"
        >
